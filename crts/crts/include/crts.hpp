...
#define CRTS_TCP_CONTROL_PORT 4445
#define CRTS_CR_PORT 4445  // UDP
...
// the controller will forcefully terminate all node processes after this
// many seconds have passed once the scenario has ended
